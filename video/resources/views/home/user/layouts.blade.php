...
<head>
    ...
    <link rel="stylesheet" href="{{asset('home_temp/style/css/base.css')}}" type="text/css"/>
    <link rel="stylesheet" href="{{asset('Home')}}" type="text/css"/>
    <link rel="stylesheet" href="{{asset('home_temp/style/css/base01.css')}}" type="text/css"/>
    <link rel="stylesheet" href="{{asset('home_temp/style/css/concerned.css')}}" type="text/css"/>
    <link rel="stylesheet" href="{{asset('home_temp/style/css/dialog_tips.css')}}" type="text/css"/>
    <link rel="stylesheet" href="{{asset('home_temp/style/css/upload.css')}}" type="text/css"/>
    <link rel="stylesheet" href="{{asset('home_temp/style/css/video.css')}}" type="text/css"/>
    <link rel="stylesheet" href="{{asset('home_temp/style/css/x_dialog.css')}}" type="text/css"/>
    <link rel="stylesheet" href="{{asset('home_temp/style/css/zclc2.css')}}" type="text/css"/>
    <link rel="stylesheet" href="{{asset('home_temp/style/css/user_base.css')}}">
    <link rel="stylesheet" href="{{asset('home_temp/style/css/user_center.css')}}">
    ...
    <div class="security-left">
        <ul class="security-list">
            <li class="f-list" style="cursor: default;"><a  class="first-level" style="color: #99a2aa;cursor: default;">个人中心</a>
                <ul class="child-list">
                    <li>
                        <a href="{{url('home_temp/home')}}" id="home" rec-linkid='account_tab_index_click' title="首页">
                            <i class="al-sy"></i>
                    ...
                    <li>
                        <a href="{{url('home_temp/message')}}" id="setting">
                            <i class="al-info"></i>
                            <span>我的信息</span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="{{url('home_temp/add')}}" id="blacklist">
                            <i class="al-bl"></i>
                            <span>上传视频</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{url('home_temp/myupload')}}" id="coin">
                            <i class="al-coin"></i>
                            <span>我的上传</span>
                        </a>
                    </li>
