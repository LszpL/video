                ...
                <div class="tpl-block ">
                    ...
                    <div class="am-g tpl-amazeui-form">
                        ...
                        <div class="am-u-sm-12 am-u-md-9">
                            ...
                            <form class="am-form am-form-horizontal" action="{{url('admin/type/doadd')}}" method="post">
								{{csrf_field()}}
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" name="type_name" placeholder="输入你要添加的类别 " value="{{old('type_name')}}">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <textarea class="" rows="5" id="user-intro"  name="type_desc" value="{{old('type_desc')}}"	 placeholder="输入分类描述"></textarea>
                                    </div>
                                </div>
