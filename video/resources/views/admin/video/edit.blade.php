                ...
                <div class="tpl-block ">
                    ...
                    <div class="am-g tpl-amazeui-form">
                        ...
                        <div class="am-u-sm-12 am-u-md-9">
                            ...
                            <form class="am-form am-form-horizontal" action="{{url('admin/video/update')}}/{{$first->video_id}}" id="art_form" method="post" enctype="mulitpart/form-data">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" name="video_name" placeholder="输入你要添加的视频名称 " value="{{$first->video_name}}">
								...
								<div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" name="video_url" placeholder="输入视频的url地址 " value="{{$first->video_url}}">
                                 ...
                                 <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <select data-am-selected="{searchBox: 1}" name="admin_name">
                                          ...
                                          <option  
                                           @if( $item->admin_name == $first->admin_name  )
                                                selected
                                           @endif 
                                            
                                          > {{$item->admin_name}}</option>
                                          @endforeach
                                ...
                                <div class="am-form-group">
                               	...
                               	<div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9"  style="width:544px; color: #999;font-weight: normal;">
											...
											<label style="height:28px;"  ><input type="checkbox" 
                                                
                                            @if(strpos($first->video_labels,$item->label_name) !== false)
                                                checked
                                            @endif
                                             name="video_labels[]" value="{{$item->label_name}}" > <font class="am-form-label" >{{$item->label_name}}</font> </label>
											@endforeach
                               ...
                               <!--  <div class="am-form-group">
								...
								<!-- 
                                <div class="am-form-group">
                                    <label for="user-intro" class="am-u-sm-3 am-form-label">下线 / 上线</label>
                                    <div class="am-u-sm-9">
                                        <div class="tpl-switch">
                                          
                                            <input type="checkbox" id="one"   name="video_status" class="ios-switch bigswitch tpl-switch-btn" checked=""  value="{{$first->video_status}}"	 style="width:150px" >
                                 ...
                                 <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <div class="am-form-group am-form-file">
                                           ...
                                           <input type="text" size="50" name="video_img" id="art_thumb" value="{{$first->video_img}}" ><br>
                                           <div class="tpl-form-file-img">
                                                <img  id="img1"  src="/{{$first->video_img}}" alt="点我选择" style="height:175px">
                                           </div>
									       <!-- <input id="file_upload" name="file_upload" type="file" multiple="true">
